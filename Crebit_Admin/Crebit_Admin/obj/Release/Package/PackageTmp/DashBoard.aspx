        ...
        function onSuccess(resObj) {
            ...
            try {
                if (resObj != null & resObj != "") {
                    if ($("#userTypeList").val() == 1) { html = "<p style='background-color:#000; font-size:20px;color:#fff;'>EnterPrise::" + resObj['totalCount'] + "</p>"; }
                    else if ($("#userTypeList").val() == 2) { html = "<p style='background-color:#000; font-size:20px;color:#fff;'>Personal::" + resObj['totalCount'] + "</p>"; }
                    else
                    {
                        html = "<p style='background-color:#000; font-size:20px;color:#fff;'>TotalUsers(EnterPrise + Personal)::" + resObj['totalCount'] + "</p>";
                    }
                }
            } catch (ex) { }
...
<body>
    ...
    <form id="dashBoardForm" runat="server">
        ...
        <%--Selction Controls --%>
        <div class="input-group" style="width: 70%; margin-left:22%">
