...
<%--        date Picker --%>
         <div class="dashboard-middle" >
            <div class="navbar-collapse collapse subData">
                <ul class="nav navbar-nav navbar-right margin5 "  style="border :3px solid #000">
                    <li>
        <%--<div class="input-group" style="float:right; margin-left:80%">--%>
<%--<div class="input-group-addon">Date </div>--%>
            <input type="text" id="DATE" class="form-control" placeholder="Select  Date" runat="server" />
                  </li>
                      <li>
                        <asp:Button Text="Filter" class="form-control btn-primary" runat="server" ID="bqtnFilter" OnClick="GetTransactionData" />
                    </li>
                </ul>
            </div>
             </div>
             
           <p id="dashBoardAdmin" class="space"></p>
      ...
      <a id="a3" href="RefundRequest.aspx?u=<%=QueryString%>">
                 ...
                 <div class="col-xs-6 col-sm-3 placeholder">
                    <table class="table table-striped" style="border: 1px solid black; width: 15%; margin-left: 10%; margin-right: 10%">
                    <thead>
                        <tr class="TableColor">
                            <th>#FundProfit </th>
                            <th>Count</th>
